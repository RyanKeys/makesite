...
[![Go Report Card](https://goreportcard.com/badge/github.com/RyanKeys/makesite)](https://goreportcard.com/report/github.com/RyanKeys/makesite)
...
- [x] Add any third party library to your project to enhance it's functionality. Some ideas you 
- [x] **_FILL IN THE BLANK_**: `I will use the Google Text to Speech library. The documentation is located at https://cloud.google.com/speech-to-text/docs/sync-recognize. My goal is to use it to convert text files into mp3 files.`
- [x] **Add, commit, and push to GitHub**.
